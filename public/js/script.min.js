...
(function ($) {
  ...
  var plusApp = {
    ...
    calculateTax: function calculateTax(tax_percent) {
      ...
      // Vuositulot.
      var vuositulot = plusApp.salary * 12.5;
      ...
      var tyoelakevakuutusmaksu = vuositulot * ($('.age_input', plus).is(':checked') ? 0.0765 : 0.0615);
    ...
    printResults: function printResults() {
      var result_container = $('.result_container', plus).empty();
      ...
      if (tax < 0) {
        ...
        var vuositulot = plusApp.salary * 12.5;
        var net_income = vuositulot - tax;
        var percent = $('.age_input', plus).is(':checked') ? 0.2024 : 0.2174;
        var total_tax = tax + net_income * 0.2 + plusApp.salary * 12.5 * percent;
